...
class Place(TimeStampedModel):
    ...
    block_place_types = models.BooleanField(default=False,
                                            help_text=_("Block <b>Place types</b> from updating from the Google Places API.<br>"
    ...
    block_google_rating = models.BooleanField(default=False,
                                              help_text=_("Block <b>Google rating</b> from updating from the Google Places API.<br>"
    ...
    block_google_price_level = models.BooleanField(default=False,
                                            help_text=_("Block <b>Google price level</b> from updating from the Google Places API.<br>"
    ...
    block_location = models.BooleanField(default=False,
                                         help_text=_("Block <b>Location</b> from updating from the Google Places API.<br>"
