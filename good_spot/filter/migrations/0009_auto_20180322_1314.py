# -*- coding: utf-8 -*-
# Generated by Django 1.11.7 on 2018-03-22 13:14
...
def migrate_filters(apps, schema_editor):
    ...
    PlaceField = apps.get_model('filter', 'PlaceField')
    ...
    for field in FieldType.objects.all():
        ...
        if field.field_type in ['choice', 'multi']:
            ...
            for place_field in field.place_fields.all():
                new_place_field = PlaceField.objects.create(
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('filter', '0008_auto_20180322_1312'),
    ]
